...
#[no_mangle]
pub unsafe extern "C" fn SHA1Transform(
...
#[no_mangle]
pub unsafe extern "C" fn SHA1Init(mut context: *mut SHA1_CTX) {
...
#[no_mangle]
pub unsafe extern "C" fn SHA1Update(
    mut context: *mut SHA1_CTX,
...
#[no_mangle]
pub unsafe extern "C" fn SHA1Final(
    ...
    SHA1Update(context, &mut c, 1 as libc::c_int as uint32_t);
    ...
    SHA1Update(context, finalcount.as_mut_ptr(), 8 as libc::c_int as uint32_t);
    i = 0 as libc::c_int as libc::c_uint;
    ...
    memset(
        ...
        '\0' as i32,
        ::core::mem::size_of::<SHA1_CTX>() as libc::c_ulong,
    );
    memset(
